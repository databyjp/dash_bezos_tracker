...
app.layout = dbc.Container([
    dbc.Jumbotron([
        ...
        dbc.Button(html.Small(html.A('Source Code', href='https://github.com/databyjp/dash_bezos_tracker', style={'color': 'white'})), color='primary'),
        ' ',
        dbc.Button(html.Small(html.A('Tutorial article', href='https://towardsdatascience.com/how-i-built-a-live-updating-jeff-bezos-wealth-tracker-web-app-incl-code-99437475ed76?source=friends_link&sk=6100304b41159a73f6216bc056641a61', style={'color': 'white'})), color='primary'),
        html.Hr(className="my-2"),
        jph_info_div,
    ]),
    html.Div([
